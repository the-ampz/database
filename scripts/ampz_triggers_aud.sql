...
AFTER INSERT OR UPDATE OR DELETE ON t_ampz_address
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
AFTER INSERT OR UPDATE OR DELETE ON t_ampz_user
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
AFTER INSERT OR UPDATE OR DELETE ON t_ampz_kid
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
AFTER INSERT OR UPDATE OR DELETE ON t_ampz_device
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
AFTER INSERT OR UPDATE OR DELETE ON t_ampz_community
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
AFTER INSERT OR UPDATE OR DELETE ON t_ampz_community_participation
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
AFTER INSERT OR UPDATE OR DELETE ON t_ampz_challenge_goal
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
AFTER INSERT OR UPDATE OR DELETE ON t_ampz_energy_consumption
FOR EACH ROW
BEGIN
    IF INSERTING THEN
...
AFTER INSERT OR UPDATE OR DELETE ON t_ampz_score
FOR EACH ROW
BEGIN
    IF INSERTING THEN
