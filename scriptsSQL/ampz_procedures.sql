...
BEGIN
    ...
    INSERT INTO t_ampz_device (
        ...
        p_ds_name,
        p_ds_type,
        p_ds_operating_system,
        p_vl_energy_consumption,
        p_vl_energy_saved
    );
...
BEGIN
    ...
    SELECT
        seq_t_ampz_community_participation.NEXTVAL
    INTO v_id_participation
    FROM
        dual;

    INSERT INTO t_ampz_community_participation (
        id_participation,
        id_kid,
        id_community,
        points
...
BEGIN
    ...
    INSERT INTO t_ampz_energy_consumption (
        ...
        v_id_energy_consumption,
        p_id_device,
        p_ds_consumption_type,
        p_vl_consumption,
        p_vl_energy_saved,
        p_dt_consumption
    );
